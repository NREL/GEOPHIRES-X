...
#            self.averageannualpumpingcosts.Name] = OutputParameter(  #typo here!??!
    ...
    def Calculate(self, model: Model) -> None:
        ...
        if self.ccwellfixed.Valid:
            ...
            # if checkdepth is > 7000 m, we don't have a correlation for it, so we must use the SIMPLE logic
            # even if we are not doing an AGS calculation
            if (checkdepth > 7000.0 or checkdepth < 500):
                msg = 'Warning: simple user-specified cost per meter used for drilling depth < 500 or > 7000 m'
                print(msg)
            ...
            if self.wellcorrelation.value == WellDrillingCostCorrelation.SIMPLE:
                ...
                self.C1well = (0.3021 * checkdepth ** 2 + 584.9112 * checkdepth + 751368.) * 1E-6
