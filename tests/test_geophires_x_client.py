    ...
    def test_extended_economic_profile(self):
        ...
        self.assertListEqual(
            [
                ...
                [8, 0.102, 0.003, 0.012, 0.0, 1.14, 1.14, -62.03, 6.27, -60.39],
                [9, 0.114, 0.0033, 0.012, 0.0, 1.14, 1.14, -60.89, 6.78, -53.61],
                [10, 0.126, 0.0036, 0.022, 0.0, 1.14, 1.14, -59.75, 7.29, -46.32],
                [11, 0.138, 0.0039, 0.032, 0.0, 1.14, 1.14, -58.61, 7.8, -38.52],
