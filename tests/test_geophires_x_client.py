    ...
    def test_extended_economic_profile(self):
        ...
        self.assertListEqual(
            [
                ...
                [6, 0.09, 0.0023, 0.012, 0.0, 1.14, 1.14, -64.31, 5.75, -72.41],
                ...
                [12, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -57.47, 8.31, -30.2],
                [13, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -56.33, 8.32, -21.89],
                [14, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -55.19, 8.32, -13.57],
                [15, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -54.05, 8.32, -5.24],
                [16, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -52.91, 8.32, 3.08],
                [17, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -51.77, 8.33, 11.41],
                [18, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -50.63, 8.33, 19.73],
                [19, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -49.49, 8.33, 28.06],
                [20, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -48.35, 8.33, 36.4],
                [21, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -47.21, 8.33, 44.73],
                [22, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -46.07, 8.33, 53.06],
                [23, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -44.93, 8.34, 61.4],
                [24, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -43.8, 8.34, 69.74],
                ...
                [28, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -39.24, 8.34, 103.1],
                [29, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -38.1, 8.34, 111.44],
                [30, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -36.96, 8.34, 119.78],
            ],
            eep,
        )
    ...
    def test_ccus_profile(self):
        ...
        self.assertListEqual(
            [
                ...
                [2, 33970785.879, 0.015, 0.51, 0.51, 0.51, 5.06, -26.01],
                [3, 34342796.074, 0.015, 0.52, 0.52, 1.02, 5.1, -20.9],
                [4, 34468751.182, 0.015, 0.52, 0.52, 1.54, 5.12, -15.79],
                [5, 34543354.013, 0.015, 0.52, 0.52, 2.06, 5.13, -10.66],
                [6, 34595651.466, 0.015, 0.52, 0.52, 2.58, 5.13, -5.53],
                [7, 34635550.413, 0.015, 0.52, 0.52, 3.1, 5.14, -0.39],
                [8, 34667603.959, 0.025, 0.87, 0.87, 3.97, 6.0, 5.61],
                [9, 34694271.287, 0.035, 1.21, 1.21, 5.18, 6.85, 12.46],
                [10, 34717025.922, 0.045, 1.56, 1.56, 6.74, 7.71, 20.17],
                [11, 34736817.704, 0.055, 1.91, 1.91, 8.65, 8.57, 28.75],
                [12, 34754293.165, 0.065, 2.26, 2.26, 10.91, 9.43, 38.18],
                [13, 34769911.37, 0.075, 2.61, 2.61, 13.52, 9.79, 47.97],
                [14, 34784009.475, 0.085, 2.96, 2.96, 16.48, 10.14, 58.1],
                [15, 34796842.046, 0.095, 3.31, 3.31, 19.78, 10.49, 68.59],
                [16, 34808605.771, 0.1, 3.48, 3.48, 23.26, 10.67, 79.26],
                [17, 34819455.61, 0.1, 3.48, 3.48, 26.74, 10.67, 89.92],
                [18, 34829515.699, 0.1, 3.48, 3.48, 30.23, 10.67, 100.6],
                [19, 34838886.901, 0.1, 3.48, 3.48, 33.71, 10.67, 111.27],
                [20, 34847652.157, 0.1, 3.48, 3.48, 37.2, 10.68, 121.95],
                [21, 34855880.343, 0.1, 3.49, 3.49, 40.68, 10.68, 132.62],
                [22, 34863629.084, 0.1, 3.49, 3.49, 44.17, 10.68, 143.31],
                [23, 34870946.822, 0.1, 3.49, 3.49, 47.65, 10.68, 153.99],
                [24, 34877874.35, 0.1, 3.49, 3.49, 51.14, 10.68, 164.67],
                [25, 34884445.953, 0.1, 3.49, 3.49, 54.63, 10.69, 175.36],
                [26, 34890690.245, 0.1, 3.49, 3.49, 58.12, 10.69, 186.05],
                [27, 34896630.809, 0.1, 3.49, 3.49, 61.61, 10.69, 196.74],
                [28, 34902286.661, 0.1, 3.49, 3.49, 65.1, 10.69, 207.43],
                [29, 34907672.604, 0.1, 3.49, 3.49, 68.59, 10.69, 218.12],
                [30, 34912799.49, 0.1, 3.49, 3.49, 72.08, 10.69, 228.82],
                [31, 29101273.713, 0.1, 2.91, 2.91, 74.99, 9.05, 237.87],
            ],
            ccus_profile,
        )
