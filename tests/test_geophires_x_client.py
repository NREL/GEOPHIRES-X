    ...
    def test_extended_economic_profile(self):
        ...
        self.assertListEqual(
            ...
            [
                ...
                [7, 0.102, 0.0026, 0.012, 0.0, 1.14, 1.14, -63.17, 5.77, -66.61],
                ...
                [25, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -42.66, 8.36, 78.46],
                [26, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -41.52, 8.36, 86.82],
                [27, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -40.38, 8.36, 95.18],
                [28, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -39.24, 8.36, 103.54],
                [29, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -38.1, 8.36, 111.9],
    ...
    def test_ccus_profile(self):
        ...
        self.assertListEqual(
            ...
            [
                ...
                [3, 34472696.061, 0.015, 0.52, 0.52, 1.03, 5.12, -20.9],
                [4, 34594857.936, 0.015, 0.52, 0.52, 1.55, 5.13, -15.76],
                [5, 34667203.032, 0.015, 0.52, 0.52, 2.07, 5.14, -10.62],
                [6, 34717913.04, 0.015, 0.52, 0.52, 2.59, 5.15, -5.48],
                [7, 34756598.286, 0.015, 0.52, 0.52, 3.11, 5.15, -0.33],
                [8, 34787675.16, 0.025, 0.87, 0.87, 3.98, 6.01, 5.69],
                [9, 34813528.834, 0.035, 1.22, 1.22, 5.2, 6.87, 12.56],
                [10, 34835588.409, 0.045, 1.57, 1.57, 6.77, 7.74, 20.3],
                [11, 34854775.046, 0.055, 1.92, 1.92, 8.68, 8.6, 28.89],
                ...
                [16, 34924363.532, 0.1, 3.49, 3.49, 23.34, 10.7, 79.55],
                [17, 34934880.239, 0.1, 3.49, 3.49, 26.83, 10.7, 90.25],
                [18, 34944631.163, 0.1, 3.49, 3.49, 30.33, 10.7, 100.95],
                [19, 34953713.933, 0.1, 3.5, 3.5, 33.82, 10.7, 111.66],
                [20, 34962208.662, 0.1, 3.5, 3.5, 37.32, 10.71, 122.36],
                [21, 34970181.608, 0.1, 3.5, 3.5, 40.82, 10.71, 133.07],
                [22, 34977687.818, 0.1, 3.5, 3.5, 44.32, 10.71, 143.79],
                [23, 34984773.045, 0.1, 3.5, 3.5, 47.81, 10.71, 154.5],
                [24, 34991475.14, 0.1, 3.5, 3.5, 51.31, 10.72, 165.21],
                [25, 34997825.066, 0.1, 3.5, 3.5, 54.81, 10.72, 175.93],
                [26, 35003847.644, 0.1, 3.5, 3.5, 58.31, 10.72, 186.65],
                [27, 35009562.099, 0.1, 3.5, 3.5, 61.81, 10.72, 197.37],
                [28, 35014982.47, 0.1, 3.5, 3.5, 65.32, 10.72, 208.09],
                [29, 35020117.916, 0.1, 3.5, 3.5, 68.82, 10.72, 218.82],
                [30, 35024972.957, 0.1, 3.5, 3.5, 72.32, 10.72, 229.54],
                [31, 35029547.662, 0.1, 3.5, 3.5, 75.82, 10.73, 240.27],
            ],
        )
