    ...
    def test_extended_economic_profile(self):
        ...
        self.assertListEqual(
            [
                ...
                [19, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -49.49, 8.37, 28.7],
                ...
                [30, 0.15, 0.0039, 0.036, 0.0, 1.14, 1.14, -36.96, 8.39, 120.89],
            ],
            eep,
        )
    ...
    def test_ccus_profile(self):
        ...
        self.assertListEqual(
            [
                ...
                [2, 34242035.25, 0.015, 0.51, 0.51, 0.51, 5.09, -25.98],
                [3, 34602531.668, 0.015, 0.52, 0.52, 1.03, 5.13, -20.85],
                [4, 34724553.252, 0.015, 0.52, 0.52, 1.55, 5.15, -15.7],
                [5, 34796819.098, 0.015, 0.52, 0.52, 2.08, 5.16, -10.55],
                [6, 34847475.212, 0.015, 0.52, 0.52, 2.6, 5.16, -5.38],
                [7, 34886120.252, 0.015, 0.52, 0.52, 3.12, 5.17, -0.21],
                [8, 34917165.394, 0.025, 0.87, 0.87, 3.99, 6.03, 5.82],
                [9, 34942993.055, 0.035, 1.22, 1.22, 5.22, 6.9, 12.71],
                [10, 34965030.71, 0.045, 1.57, 1.57, 6.79, 7.76, 20.48],
                [11, 34984198.487, 0.055, 1.92, 1.92, 8.71, 8.63, 29.1],
                [12, 35001122.677, 0.065, 2.28, 2.28, 10.99, 9.49, 38.6],
                [13, 35016247.966, 0.075, 2.63, 2.63, 13.62, 9.85, 48.44],
                [14, 35029900.94, 0.085, 2.98, 2.98, 16.59, 10.2, 58.64],
                [15, 35042328.175, 0.095, 3.33, 3.33, 19.92, 10.55, 69.2],
                [16, 35053720.175, 0.1, 3.51, 3.51, 23.43, 10.73, 79.93],
                [17, 35064226.998, 0.1, 3.51, 3.51, 26.93, 10.74, 90.67],
                [18, 35073968.794, 0.1, 3.51, 3.51, 30.44, 10.74, 101.41],
                [19, 35083043.073, 0.1, 3.51, 3.51, 33.95, 10.74, 112.15],
                [20, 35091529.833, 0.1, 3.51, 3.51, 37.46, 10.74, 122.89],
                [21, 35099495.213, 0.1, 3.51, 3.51, 40.97, 10.75, 133.64],
                [22, 35106994.126, 0.1, 3.51, 3.51, 44.48, 10.75, 144.39],
                [23, 35114072.168, 0.1, 3.51, 3.51, 47.99, 10.75, 155.14],
                [24, 35120766.996, 0.1, 3.51, 3.51, 51.5, 10.75, 165.89],
                [25, 35127109.346, 0.1, 3.51, 3.51, 55.02, 10.75, 176.64],
                [26, 35133123.761, 0.1, 3.51, 3.51, 58.53, 10.76, 187.4],
                [27, 35138829.14, 0.1, 3.51, 3.51, 62.04, 10.76, 198.16],
                [28, 35144239.144, 0.1, 3.51, 3.51, 65.56, 10.76, 208.92],
                [29, 35149362.497, 0.1, 3.51, 3.51, 69.07, 10.76, 219.68],
                [30, 35154203.228, 0.1, 3.52, 3.52, 72.59, 10.76, 230.44],
                [31, 29302202.672, 0.1, 2.93, 2.93, 75.52, 9.11, 239.54],
            ],
            ccus_profile,
        )
